...
<title>Digital Footprint — Clarity (Offline)</title>
<style>
  :root{
    --accent: #3366ff;
    --accent-2: #254bdb;
  ...
  /* Enhanced logo with modern shield design */
  ...
  .logo svg { width:36px; height:36px; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3)); }
...
<div class="site">
  <header>
    <div class="brand">
      <!-- Enhanced Digital Footprint Logo: Shield with circuit pattern -->
      <div class="logo" title="Digital Footprint — Clarity">
        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
          ...
          <!-- Shield background -->
          <path d="M16 3L7 7.5v7.5c0 5.5 3.8 10.5 9 12 5.2-1.5 9-6.5 9-12V7.5L16 3z" 
          ...
          <g fill="rgba(255,255,255,0.95)" stroke="rgba(255,255,255,0.7)" stroke-width="0.4">
            <!-- Central hub -->
            <circle cx="16" cy="16" r="2" fill="white" stroke="rgba(255,255,255,0.9)" stroke-width="0.5"/>
            
            <!-- Primary connection lines -->
            <line x1="16" y1="9" x2="16" y2="14" stroke-width="0.6"/>
            <line x1="16" y1="18" x2="16" y2="23" stroke-width="0.6"/>
            <line x1="9" y1="16" x2="14" y2="16" stroke-width="0.6"/>
            <line x1="18" y1="16" x2="23" y2="16" stroke-width="0.6"/>
            
            <!-- Diagonal connections -->
            <line x1="12" y1="12" x2="14.5" y2="14.5" stroke-width="0.5"/>
            <line x1="20" y1="12" x2="17.5" y2="14.5" stroke-width="0.5"/>
            <line x1="12" y1="20" x2="14.5" y2="17.5" stroke-width="0.5"/>
            <line x1="20" y1="20" x2="17.5" y2="17.5" stroke-width="0.5"/>
            
            <!-- Network nodes -->
            <circle cx="16" cy="9" r="1.2" fill="rgba(255,255,255,0.9)"/>
            <circle cx="16" cy="23" r="1.2" fill="rgba(255,255,255,0.9)"/>
            <circle cx="9" cy="16" r="1.2" fill="rgba(255,255,255,0.9)"/>
            <circle cx="23" cy="16" r="1.2" fill="rgba(255,255,255,0.9)"/>
            
            <!-- Corner nodes -->
            <circle cx="12" cy="12" r="0.8" fill="rgba(255,255,255,0.8)"/>
            <circle cx="20" cy="12" r="0.8" fill="rgba(255,255,255,0.8)"/>
            <circle cx="12" cy="20" r="0.8" fill="rgba(255,255,255,0.8)"/>
            <circle cx="20" cy="20" r="0.8" fill="rgba(255,255,255,0.8)"/>
            
            <!-- Data points -->
            <circle cx="11" cy="9" r="0.4" fill="rgba(255,255,255,0.7)"/>
            <circle cx="21" cy="9" r="0.4" fill="rgba(255,255,255,0.7)"/>
            <circle cx="11" cy="23" r="0.4" fill="rgba(255,255,255,0.7)"/>
            <circle cx="21" cy="23" r="0.4" fill="rgba(255,255,255,0.7)"/>
          </g>
      ...
      <div>
        <h1>Digital Footprint — Clarity</h1>
        <div class="tag">Understand · Improve · Protect</div>
      </div>
    </div>
    ...
    <nav>
      ...
      <button class="btn small" onclick="toggleChat()"><span style="margin-right:6px">🤖</span>Clarity Bot</button>
    </nav>
  </header>
  ...
  <main class="card-main">
      ...
      <div class="hero">
        <div class="hero-left">
          <div style="margin-bottom:12px">
            <div class="big-title">Welcome to <span style="color:var(--accent)">Digital Footprint — Clarity</span></div>
          ...
          <div class="info-grid">
            <div class="info-box">
              ...
              <p class="muted">All the traces you leave while using the internet — social posts, photos, app permissions, search history, and more. These traces can reveal personal patterns and sensitive details.</p>
            </div>
            <div class="info-box">
            ...
            <div class="info-box">
              ...
              <p class="muted">Quick quiz, personalized feedback, and a local-only history per email. No servers — your data stays on your browser unless you export it yourself.</p>
            </div>
            <div class="info-box">
              <h3>Who should use it?</h3>
              <p class="muted">Everyone — from teens posting photos to adults using online banking. The app is beginner-friendly and actionable.</p>
            </div>
          </div>
          ...
          <div class="faq" style="margin-top:12px">
            ...
            <div class="faq-item">
              ...
              <div class="faq-a">No — everything is stored locally in your browser. Each email's history is stored locally and only visible from the same browser.</div>
            </div>
            ...
            <div class="faq-item">
              ...
              <div class="faq-a">Private to this browser and the email you use. If someone uses the same browser and email, they will see the same history — so protect your device.</div>
            </div>
            ...
            <div class="faq-item">
              ...
              <div class="faq-a">Yes — go to History while logged in and clear entries individually or all at once.</div>
            </div>
            ...
            <div class="faq-item">
              ...
              <div class="faq-a">The quiz asks about your online habits. Each answer contributes to a score that reflects your digital footprint risk. After submitting, you'll get personalized tips.</div>
            </div>
        ...
        <aside class="hero-right">
          <div class="side-card">
            ...
            <div class="muted">1) Click Take Quiz → 2) Enter name & email → 3) Answer honestly → 4) Review suggestions & save progress.</div>
    ...
    <section id="quizPage" class="page" aria-hidden="true">
      <div style="display:flex; justify-content:space-between; align-items:center">
        <h2 style="margin:0;color:var(--accent-2)">Quiz — quick & interactive</h2>
        <div>
  ...
  <footer style="text-align:center; color:rgba(255,255,255,0.75); margin-top:18px;">
    © <span id="year"></span> Digital Footprint — Clarity · Offline version
  </footer>
</div>
...
<div id="chatWindow" class="chat-window" style="display:none" aria-hidden="true">
  ...
  <div class="chat-input">
    <input id="chatInput" placeholder="Say hi — try: 'how to enable 2FA' or 'what is a digital footprint?'" onkeydown="if(event.key==='Enter'){sendChat();}" />
...
function submitQuiz(){
  ...
  if(!cur){ alert('Session expired — please re-enter your name and email.'); showSection('namePage'); return; }
  let score = 0;
  const answers = {};
  ...
  document.getElementById('resTag').textContent = level === 'low' ? 'Low risk — Nice work!' : level === 'medium' ? 'Moderate risk — room to improve' : 'High risk — take action soon';
...
function buildPersonalizedTips(details, percent){
  ...
  if(details['2fa'] !== 'Yes'){
    ...
    list.push({ title: '2FA enabled — good', body: 'You have 2FA enabled — keep your recovery codes in a safe place and consider using a hardware key for critical accounts.' });
  }
  ...
  list.push({ title: 'Make a simple action plan', body: 'Pick 2 actions (enable 2FA, change 3 reused passwords) and do them this week — small wins compound.' });
...
function openChat(){
  ...
  setTimeout(()=> botSay("👋 Hi! I'm Clarity Bot. How may I help you?"), 250);
  startBlink();
}
function closeChat(){
